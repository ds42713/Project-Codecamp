...
function MoviePost({ setShowModal, movie }) {
  ...
  function ButtonCreateFavorite({createList}) {
    return (
      <button className=' border-2 hover:bg-red-700 border-red-700 text-white  font-bold uppercase text-sm px-3 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 flex flex-row' onClick={createList}>
        favorite
      </button>
    );
  }
  ...
  function ButtonDelateFavorite({deleteList}) {
    return (
      <button  className=' hover:bg-gray-800   bg-red-700 border-2 border-red-700 text-white  font-bold uppercase text-sm px-3 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 flex flex-row' onClick={deleteList} >
        favorite
      </button>
    );
  }
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-hidden fixed inset-0 z-50 outline-none focus:outline-none w-full h-fit " >
                    ...
                    <div className="flex items-center ">
                      <div className="flex items-center ">
                        ...
                        <Link to={`movie/${movie.id}`}>
                          <button className="rounded-md border-2 border-red-700 text-white hover:bg-red-700 font-bold uppercase text-sm px-3 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button" onClick={() => setShowModal(false)} >
                            detail
                          </button>
                        </Link>
